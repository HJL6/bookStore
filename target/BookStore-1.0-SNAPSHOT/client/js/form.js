...
function checkEmail() {			// 验证邮箱
	...
	emailObj.parentNode.parentNode.style.color = msg == "" ? "green" : "red";
	return msg == "";
}
...
function checkUsername() {		// 验证用户名
	...
	usernameObj.parentNode.parentNode.style.color = msg == "" ? "green" : "red";	// 根据消息结果改变tr的颜色
...
function checkPassword() {		// 验证密码
	...
	passwordObj.parentNode.parentNode.style.color = msg == "" ? "green" : "red";
	return msg == "";
}
...
function checkConfirm() {		// 验证确认密码
	...
	confirmObj.parentNode.parentNode.style.color = msg == "" ? "green" : "red";
	return msg == "";
}
