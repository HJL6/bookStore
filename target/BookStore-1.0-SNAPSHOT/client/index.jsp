...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/client/js/autoplay.js" charset=UTF-8></script>
</head>
<body class="main">
			...
			<tr>
				<td width="497">
					...
					<table cellspacing="0" class="ctl">
						<c:forEach items="${n}" var="p">
							<tr>
								<td width="485" height="29">${p.details}</td>
							</tr>
						</c:forEach>
					</table>
				</td>
